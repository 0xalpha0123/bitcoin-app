...
async function setFacebookAppIdString(config, projectRoot) {
  ...
  (0, _assert().default)(stringsPath, `There was a problem setting your Facebook App ID in "${stringsPath}"`);
...
function setFacebookConfig(config, androidManifest) {
  ...
  if (appId) {
    mainApplication = (0, _Manifest().addMetaDataItemToMainApplication)(mainApplication, META_APP_ID, // The corresponding string is set in setFacebookAppIdString
