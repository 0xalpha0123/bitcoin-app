...
function withIntrospectionBaseMods(config, props = {}) {
  const iosProviders = (0, _withIosBaseMods().getIosIntrospectModFileProviders)();
  const androidProviders = (0, _withAndroidBaseMods().getAndroidIntrospectModFileProviders)();
  ...
  if (config.mods) {
    ...
    for (const platform of Object.keys(config.mods)) {
      ...
      for (const key of Object.keys(config.mods[platform] || {})) {
        if (!(platformPreserve !== null && platformPreserve !== void 0 && platformPreserve.includes(key))) {
          // @ts-ignore
      ...
      for (const [modName, mod] of entries) {
        ...
        if (!mod.isProvider) {
          ...
          if (assertMissingModProviders !== false) {
            ...
            if ((_config$_internal = config._internal) !== null && _config$_internal !== void 0 && _config$_internal.isDebug) {
