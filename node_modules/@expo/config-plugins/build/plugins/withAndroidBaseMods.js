...
const defaultProviders = {
  ...
  manifest: (0, _createBaseMod().provider)({
    ...
    async write(filePath, {
      ...
      await _android().Manifest.writeAndroidManifestAsync(filePath, modResults);
    }
        ...
        return {
          manifest: {
            $: {
              ...
              package: (_config$android$packa = (_config$android = config.android) === null || _config$android === void 0 ? void 0 : _config$android.package) !== null && _config$android$packa !== void 0 ? _config$android$packa : 'com.placeholder.appid'
            },
            'uses-permission': [{
              $: {
